...
PRIMARY KEY (productID)
        ...
        */
        String updateProductTable = "UPDATE product SET productID = ?, productName = ?, productType = ?, manufacturer = ? where ProductID = ?";
        
        
        
        for (Object fields : product.getFields()) {
            ...
            updateProductStatement.setString(1, (String) fields);
